...
The Rule Set file has XML format, however, Visual Studio allows to configure the~severity of the~rules simply by right-clicking on the~analyzer reference in \textit{Solution Explorer} window, as seen in Figure~\ref{fig:setting-analyzer-severity}.
