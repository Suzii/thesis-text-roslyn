...
% =================================================================
\chapter{Conclusion}
The goal of this thesis was to create a custom static code analysis tool for Kentico company, using the new .NET Compiler Platform (\textit{"Roslyn"}). The tool was supposed to replace an existing console application that scans the Kentico source codes, and searches for violations of company's internal rules and coding guidelines.

The theoretical part of the thesis explain the ... The second part of this thesis descries the implementation of custom analyzers. It gives an insight to semantic grouping of the analyzers into categories and presents ... the 6th chapter ... performance considratoins...
...
1. State the goal of the thesis

?. Struktura jedny, paragrafom 

2. Were the goal met? What is the current statu
 if the project?
 
3. How can be the work extended?
